...
function Message() {
    ...
    return (
        <>
            <section className="md:ml-96 h-full mt-22 relative overflow-y-scroll scobar">
                <div className="flex   w-full p-4 rounded-xl items-center dark:bg-gray-800 bg-[#f2efe6]  z-12 md:gap-10 gap-5 ml-3 dark:text-white">
