  ...
  return (
    <>
      ...
      <section className='md:ml-96 md:mt-17  md:mb-0 mb-0 flex pt-15'>
        ...
        <div className="  w-full md:max-h-[590px] max-h-[750px] overflow-y-scroll snap-y snap-mandatory scroll-mt-50 ">
                  ...
                  items.type === "video" ? (
                    <div className="">
                      <div className="md:snap-end  snap-start  snap-always relative " key={i}>
                        ...
                        <div className="absolute  w-full mt-130 md:mt-80 z-12 ">
                          ...
                          <div className={`  max-h-[200px]  z-13 relative overflow-h flex mt-45 md:mt-60 flex-col-reverse w-[85%] transition-[height  duration-300 ease-in-out`}>
