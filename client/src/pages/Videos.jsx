...
function Videos() {
  ...
  return (
    <>
      ...
      <section className='md:ml-96 md:mt-17  md:mb-0 mb-0 flex pt-15'>
        {commentshow && <Comment view={setCommentshow} commentid={comment} postId={postid} />}
        <div className="  w-full md:max-h-[590px] max-h-[700px] overflow-y-scroll snap-y snap-mandatory scroll-mt-50 ">
                  ...
                  items.type === "video" ? (
                    <div className="">
                      <div className="md:snap-end  snap-start  snap-always relative " key={i}>
                        ...
                        <div className="absolute  w-full mt-100 md:mt-80 z-12 ">
                        ...
                        <video
                          ...
                          className='dura h-[700px] mb-3 overflow-hidden object-cover md:rounded-lg md:shadow-xl md:hover:dark:shadow-[#48a6a6] md:shadow-black  md:h-[560px] md:w-[340px] '
