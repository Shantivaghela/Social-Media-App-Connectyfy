    ...
    <>
      ...
      <ul role="list" className="">
        {following.length > 0 ? (following.map(user=>(
                            <li className="py-3 sm:py-4 bg-white px-2 flex justify-between  mb-2 rounded-lg dark:hover:bg-gray-900 hover:bg-gray-100 dark:bg-gray-800  w-[99%] divide-y divide-gray-200 dark:divide-gray-700 mr-5s">
