...
<nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-10 ">
  <div class=" flex  items-center justify-between mx-auto px-5 py-4 ">
    <div>
    <a href="https://flowbite.com/" class="flex items-center space-x-2 rtl:space-x-reverse">
        ...
        <img src={assets.connectyfy} class="h-6 md:h-11 " alt="Flowbite Logo" />
    ...
    <div class=" w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-co float-right  md:p-0 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-6 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
