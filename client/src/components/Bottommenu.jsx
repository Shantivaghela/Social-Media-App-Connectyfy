    ...
    return (
        <>
            <section>
                ...
                <nav class="bg-white items-center  border-gray-200 dark:bg-gray-900 md:hidden block fixed bottom-0 w-[100%] justify-center">
                    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">


                        <div class="items-center justify-center w-full h-10 hb-20 flex md:w-auto md:order-1 " id="navbar-user">
                            <ul class="flex w-full  font-medium items-center justify-between  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                <li>
